...
Page({
  ...
  data: {
    ...
    jiage:[
      ...
      { jg: '20万以下', jgkey: '1', jgsousuo: 'j0' },
      { jg: '20-40万', jgkey: '2', jgsousuo: 'j1' },
      { jg: '40-60万', jgkey: '3', jgsousuo: 'j2' },
      { jg: '60-80万', jgkey: '4', jgsousuo: 'j3' },
      { jg: '80-100万', jgkey: '5', jgsousuo: 'j4' },
      { jg: '100万以上', jgkey: '6', jgsousuo: 'j5' }
    ],
    hux: [
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://yuanmengjiafc.com/xiao/eslistcs.php', //仅为示例，并非真实的接口地址
      data: {
        page:that.data.page,
        key:that.data.key
      },
  ...
  onReachBottom: function () {
    ...
    wx.request({
      url: 'http://yuanmengjiafc.com/xiao/eslist.php', //仅为示例，并非真实的接口地址
      data: {
        page: that.data.page,
        qy: that.data.qytj,
        jg: that.data.jgtj,
  ...
  xiala:function(){
    ...
    wx.request({
      url: 'http://yuanmengjiafc.com/xiao/esxl.php', //仅为示例，并非真实的接口地址
      data: {
        page: 1
      },
      header: {
